...
export const servicesData = [
  ...
  },
  {
    icon: "family_group",
    title: "Family Law",
    description: "Mediation and legal support for family disputes, led by Mr Ngengebule and Miss Tshabalala."
  },
  {
    icon: "request_quote",
    title: "Corporate Collections",
    description: "Efficient processes for debt collection and litigation, providing fast and innovative solutions for businesses."
  },
  {
    icon: "corporate_fare",
  ...
  },
  {
    ...
    description: "Transfers, leases, sales, subdivisions, registrations, and property structuring, led by Miss Tshabalala."
  }
];